...
In this project our team developed own implementation of the string.h library in C programming language. As part of the project you’ll work on tasks with string data and consolidate the structured approach.
...
## Part 2. Bonus. Implementation of special string processing functions
